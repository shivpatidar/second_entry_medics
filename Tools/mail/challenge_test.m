function classifyResult = challenge_test(ecg)
%
...
%label = predict(rusTree,data);%bag of tree based decision

label = predict(rusTree,data(idxvar))
%label = predict(Mdl2,data);%bag of tree based decision
switch label
    case 1
        classifyResult ='A';
    case 2
